#!/usr/bin/env python3
"""
Save Random Forest Model for Fertilizer Recommendation
"""
...
def save_fertilizer_rf_model():
    """Train and save Random Forest model for fertilizer recommendation"""
    ...
    # Save label encoders
    pickle.dump(lb, open('fertilizer_label_encoder.sav', 'wb'))
    ...
    return rf_model, sc, lb, fert_reverse_dict

if __name__ == "__main__":
    save_fertilizer_rf_model() 