#!/usr/bin/env python3
"""
Test script to verify that both models are working correctly
"""
...
def test_models():
    ...
    print("Testing Crop & Fertilizer Recommendation Models")
    print("=" * 50)
    ...
    try:
        ...
        crop_prediction = crop_model.predict(test_crop_scaled)[0]
        crop_probabilities = crop_model.predict_proba(test_crop_scaled)[0]
        recommended_crop = crop_dict[crop_prediction]
        confidence = crop_probabilities[crop_prediction - 1] * 100
        ...
        fertilizer_prediction = fertilizer_model.predict(test_fertilizer_scaled)[0]
        fertilizer_probabilities = fertilizer_model.predict_proba(test_fertilizer_scaled)[0]
        recommended_fertilizer = fertilizer_dict[fertilizer_prediction]
        confidence = fertilizer_probabilities[fertilizer_prediction - 1] * 100
